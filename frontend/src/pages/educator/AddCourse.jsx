  ...
  return (
    ...
    justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      ...
      <div className='flex flex-col gap-1'>
        <p>Course Title</p>
        <input onChange={e => setCourseTitle(e.target.value)}  value={courseTitle} type="text" placeholder='Type here' className='
        outline-none md:py-2.5 py-2 px-3 rounded border border-gray-500' required />
      </div>
      <div className='flex flex-col gap-1'>
      ...
      <div>
          ...
          <div key={chapterIndex} className='bg-white border rounded-lg mb-4'>
            <div className='flex justify-between items-center p-4 border-b'>
             ...
             <img onClick={()=>handleChapter('remove', chapter.chapterId)}
              src={assets.cross_icon} className='cursor-pointer' alt="" />
            </div>
            {!chapter.collapsed && (
              <div className='p-4'>
        ...
        <div onClick={()=>handleChapter('add')} className='flex justify-center item-center bg-blue-100 p-2 rounded-lg cursor-pointer'>
          + Add Chapter
        </div>
        {
          showPopup && (
            <div className='fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50'>
              <div className='bg-white text-gray-700 p-4 rounded relative w-full max-w-80 '>
                <h2 className='text-lg font-semibold mb-4'>Add Lecture</h2>
                 ...
                 <img src={assets.cross_icon} onClick={()=>setShowPopup} className='absolute top-4 right-4 w-4 cursor-pointer' alt="" />
              </div>
