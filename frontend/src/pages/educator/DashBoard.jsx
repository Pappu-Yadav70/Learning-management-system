  ...
  return dashboardData ? (
    ...
    md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <div className='space-y-5'>
       <div className='flex flex-wrap gap-5 items-center'>
        <div className='flex items-center gap-3 shadow-card border border-blue-500 p-4 w-56 rounded-md'>
          <img src={assets.patients_icon} alt="" />
           <div>
            <p className='text-2xl font-medium text-gray-600'>{dashboardData.enrolledStudentData}</p>
       ...
       <div>
        <h2 className='pb-4 text-lg font font-medium'>Latest Enrollments</h2>
              ...
              {dashboardData.enrolledStudentsData.map((item,index)=> (
                <tr key={index} className='border-b border-gray-500/20'>
                  ...
                  <td className='md:px-4 px-2 py-3 flex items-center space-x-3'>
                    ...
                    <span className='truncate'>{item.student.name}
